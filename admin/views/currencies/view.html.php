...
/**
 * Supportgroups View class for the Currencies
 */
class SupportgroupsViewCurrencies extends JViewLegacy
{
	/**
	...
	function display($tpl = null)
	{
		if ($this->getLayout() !== 'modal')
		{
			...
			SupportgroupsHelper::addSubmenu('currencies');
		}
		...
		$this->canDo = SupportgroupsHelper::getActions('currency');
	...
	{
		JToolBarHelper::title(JText::_('COM_SUPPORTGROUPS_CURRENCIES'), 'credit-2');
		JHtmlSidebar::setAction('index.php?option=com_supportgroups&view=currencies');
		...
		if (SupportgroupsHelper::checkArray($this->items))
		{
			...
			{
				JToolBarHelper::custom('currencies.exportData', 'download', '', 'COM_SUPPORTGROUPS_EXPORT_DATA', true);
			}
		}

		if ($this->canDo->get('core.import') && $this->canDo->get('currency.import'))
		{
			JToolBarHelper::custom('currencies.importData', 'upload', '', 'COM_SUPPORTGROUPS_IMPORT_DATA', false);
		}

		// set help url for this view if found
		$this->help_url = SupportgroupsHelper::getHelpUrl('currencies');
	...
	protected function setDocument()
	{
		...
		$this->document->setTitle(JText::_('COM_SUPPORTGROUPS_CURRENCIES'));
		$this->document->addStyleSheet(JURI::root() . "administrator/components/com_supportgroups/assets/css/currencies.css", (SupportgroupsHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/css');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.name' => JText::_('COM_SUPPORTGROUPS_CURRENCY_NAME_LABEL'),
			'a.codethree' => JText::_('COM_SUPPORTGROUPS_CURRENCY_CODETHREE_LABEL'),
			'a.numericcode' => JText::_('COM_SUPPORTGROUPS_CURRENCY_NUMERICCODE_LABEL'),
			'a.decimalplace' => JText::_('COM_SUPPORTGROUPS_CURRENCY_DECIMALPLACE_LABEL'),
