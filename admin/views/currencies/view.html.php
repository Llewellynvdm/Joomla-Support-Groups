...
class SupportgroupsViewCurrencies extends JViewLegacy
{
	...
	protected function setDocument()
	{
		...
		$document->setTitle(JText::_('COM_SUPPORTGROUPS_CURRENCIES'));
		$document->addStyleSheet(JURI::root() . "administrator/components/com_supportgroups/assets/css/currencies.css");
	}
