...
class SupportgroupsViewHelp_document extends JViewLegacy
{
	...
	protected function setDocument()
	{
		...
		$document->setTitle(JText::_($isNew ? 'COM_SUPPORTGROUPS_HELP_DOCUMENT_NEW' : 'COM_SUPPORTGROUPS_HELP_DOCUMENT_EDIT'));
		$document->addStyleSheet(JURI::root() . "administrator/components/com_supportgroups/assets/css/help_document.css"); 
		$document->addScript(JURI::root() . $this->script);
		$document->addScript(JURI::root() . "administrator/components/com_supportgroups/views/help_document/submitbutton.js");
