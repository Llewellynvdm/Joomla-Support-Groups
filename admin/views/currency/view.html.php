...
class SupportgroupsViewCurrency extends JViewLegacy
{
	...
	protected function setDocument()
	{
		...
		$document->setTitle(JText::_($isNew ? 'COM_SUPPORTGROUPS_CURRENCY_NEW' : 'COM_SUPPORTGROUPS_CURRENCY_EDIT'));
		$document->addStyleSheet(JURI::root() . "administrator/components/com_supportgroups/assets/css/currency.css"); 
		$document->addScript(JURI::root() . $this->script);
		$document->addScript(JURI::root() . "administrator/components/com_supportgroups/views/currency/submitbutton.js");
