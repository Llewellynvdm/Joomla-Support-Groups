...
class SupportgroupsViewAdditional_information extends JViewLegacy
{
	...
	protected function addToolBar()
	{
		...
		$this->info_typeNameOptions = JFormHelper::loadFieldType('Infotype')->getOptions();
		if ($this->info_typeNameOptions)
		{
			...
			JHtmlSidebar::addFilter(
				...
				'filter_info_type',
				JHtml::_('select.options', $this->info_typeNameOptions, 'value', 'text', $this->state->get('filter.info_type'))
			);
