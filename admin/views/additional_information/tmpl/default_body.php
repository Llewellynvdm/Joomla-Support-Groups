...
$edit = "index.php?option=com_supportgroups&view=additional_information&task=additional_info.edit";
...
<?php foreach ($this->items as $i => $item): ?>
	<?php
		...
		$canDo = SupportgroupsHelper::getActions('additional_info',$item,'additional_information');
	?>
	<tr class="row<?php echo $i % 2; ?>">
		<td class="order nowrap center hidden-phone">
		<?php if ($canDo->get('additional_info.edit.state')): ?>
			<?php
				if ($this->saveOrder)
				{
					$iconClass = ' inactive';
		...
		<?php if ($canDo->get('additional_info.edit.state')) : ?>
				<?php if ($item->checked_out) : ?>
					<?php if ($canCheckin) : ?>
						<?php echo JHtml::_('jgrid.published', $item->published, $i, 'additional_information.', true, 'cb'); ?>
					<?php else: ?>
						<?php echo JHtml::_('jgrid.published', $item->published, $i, 'additional_information.', false, 'cb'); ?>
					<?php endif; ?>
				<?php else: ?>
					<?php echo JHtml::_('jgrid.published', $item->published, $i, 'additional_information.', true, 'cb'); ?>
				<?php endif; ?>
