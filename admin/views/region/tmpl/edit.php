...
<div class="form-horizontal">
	...
	<?php echo JHtml::_('bootstrap.addTab', 'regionTab', 'publishing', JText::_('COM_SUPPORTGROUPS_REGION_PUBLISHING', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			...
			<div class="span6">
				<?php echo JLayoutHelper::render('region.metadata', $this); ?>
			</div>
		</div>
	<?php echo JHtml::_('bootstrap.endTab'); ?>
	<?php endif; ?>
	...
	<?php echo JHtml::_('bootstrap.addTab', 'regionTab', 'permissions', JText::_('COM_SUPPORTGROUPS_REGION_PERMISSION', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
