...
$edit = "index.php?option=com_supportgroups&view=countries&task=country.edit";
...
<?php foreach ($this->items as $i => $item): ?>
	<?php
		...
		$canDo = SupportgroupsHelper::getActions('country',$item,'countries');
	?>
	<tr class="row<?php echo $i % 2; ?>">
		...
		<td class="nowrap">
			<?php if ($this->user->authorise('currency.edit', 'com_supportgroups.currency.' . (int)$item->currency)): ?>
				<div class="name">
					<a href="index.php?option=com_supportgroups&view=currencies&task=currency.edit&id=<?php echo $item->currency; ?>&ref=countries"><?php echo $this->escape($item->currency_name); ?></a>
				</div>
			<?php else: ?>
				<div class="name"><?php echo $this->escape($item->currency_name); ?></div>
			<?php endif; ?>
		</td>
