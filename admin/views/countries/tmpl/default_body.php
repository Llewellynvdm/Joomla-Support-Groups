		...
		<td class="nowrap">
			<div class="name">
				<?php if ($this->user->authorise('currency.edit', 'com_supportgroups.currency.' . (int)$item->currency)): ?>
					<a href="index.php?option=com_supportgroups&view=currencies&task=currency.edit&id=<?php echo $item->currency; ?>&return=<?php echo $this->return_here; ?>"><?php echo $this->escape($item->currency_name); ?></a>
				<?php else: ?>
