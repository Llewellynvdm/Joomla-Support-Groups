...
class SupportgroupsViewSupport_group extends JViewLegacy
{
	...
	protected function addToolBar()
	{
		...
		$this->help_url = SupportgroupsHelper::getHelpUrl('support_group');
	...
	protected function setDocument()
	{
		...
		$this->document->addScript(JURI::root() . "administrator/components/com_supportgroups/views/support_group/submitbutton.js", (SupportgroupsHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/javascript'); 
