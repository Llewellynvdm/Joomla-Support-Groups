...
$edit = "index.php?option=com_supportgroups&view=help_documents&task=help_document.edit";
...
<?php foreach ($this->items as $i => $item): ?>
	<?php
		...
		$canDo = SupportgroupsHelper::getActions('help_document',$item,'help_documents');
	?>
