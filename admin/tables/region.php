 ...
 * Regions Table class
 */
class SupportgroupsTableRegion extends JTable
{
	/**
	...
	/**
	 * Overload the store method for the Region table.
	 *
	...
	public function store($updateNulls = false)
	{
		...
		{
			// New region. A region created and created_by field can be set by the user,
		...
		if (isset($this->alias))
		{
			...
			{
				$this->setError(JText::_('COM_SUPPORTGROUPS_REGION_ERROR_UNIQUE_ALIAS'));
				return false;
			}
		}
	...
	public function check()
	{
		...
		if (!$this->getRules())
		{
			$rules = $this->getDefaultAssetValues('com_supportgroups.region.'.$this->id);
			$this->setRules($rules);
		}
	...
	{
		$k = $this->_tbl_key;
		return 'com_supportgroups.region.'.(int) $this->$k;
	}
