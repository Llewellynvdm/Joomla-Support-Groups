 ...
 */
class SupportgroupsTableCurrency extends JTable
{
	/**
	...
	{
		parent::__construct('#__supportgroups_currency', 'id', $db);

		// Adding History Options
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_supportgroups.currency'));
	}	
	...
	public function store($updateNulls = false)
	{
		...
		if (isset($this->alias))
		{
			...
			{
				$this->setError(JText::_('COM_SUPPORTGROUPS_CURRENCY_ERROR_UNIQUE_ALIAS'));
				return false;
			}
		}
	...
	public function check()
	{
		...
		if (!$this->getRules())
		{
			$rules = $this->getDefaultAssetValues('com_supportgroups.currency.'.$this->id);
			$this->setRules($rules);
		}
	...
	{
		$k = $this->_tbl_key;
		return 'com_supportgroups.currency.'.(int) $this->$k;
	}
