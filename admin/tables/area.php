 ...
 * Areas Table class
 */
class SupportgroupsTableArea extends JTable
{
	/**
	...
	{
		parent::__construct('#__supportgroups_area', 'id', $db);

		// Adding History Options
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_supportgroups.area'));
	}	
	...
	/**
	 * Overload the store method for the Area table.
	 *
	...
	public function store($updateNulls = false)
	{
		...
		{
			// New area. A area created and created_by field can be set by the user,
		...
		if (isset($this->alias))
		{
			...
			{
				$this->setError(JText::_('COM_SUPPORTGROUPS_AREA_ERROR_UNIQUE_ALIAS'));
				return false;
			}
		}
	...
	public function check()
	{
		...
		if (!$this->getRules())
		{
			$rules = $this->getDefaultAssetValues('com_supportgroups.area.'.$this->id);
			$this->setRules($rules);
		}
	...
	{
		$k = $this->_tbl_key;
		return 'com_supportgroups.area.'.(int) $this->$k;
	}
