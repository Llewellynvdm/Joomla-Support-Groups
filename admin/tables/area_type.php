...
/**
 * Area_types Table class
 */
class SupportgroupsTableArea_type extends JTable
{
	/**
	...
	{
		parent::__construct('#__supportgroups_area_type', 'id', $db);

		// Adding History Options
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_supportgroups.area_type'));
	}	
	...
	/**
	 * Overload the store method for the Area_type table.
	 *
	...
	public function store($updateNulls = false)
	{
		...
		{
			// New area_type. A area_type created and created_by field can be set by the user,
		...
		if (isset($this->alias))
		{
			...
			{
				$this->setError(JText::_('COM_SUPPORTGROUPS_AREA_TYPE_ERROR_UNIQUE_ALIAS'));
				return false;
			}
		}
	...
	public function check()
	{
		...
		if (!$this->getRules())
		{
			$rules = $this->getDefaultAssetValues('com_supportgroups.area_type.'.$this->id);
			$this->setRules($rules);
		}
	...
	{
		$k = $this->_tbl_key;
		return 'com_supportgroups.area_type.'.(int) $this->$k;
	}
