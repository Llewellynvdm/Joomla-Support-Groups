...
/**
 * Helpdocumentsfilterlocation Form Field class for the Supportgroups component
 */
class JFormFieldHelpdocumentsfilterlocation extends JFormFieldList
{
	...
	protected function getOptions()
	{
		...
		$_filter = array();
		$_filter[] = JHtml::_('select.option', '', '- ' . JText::_('COM_SUPPORTGROUPS_FILTER_SELECT_LOCATION') . ' -');

		if ($results)
		{
			// get help_documentsmodel
			$model = SupportgroupsHelper::getModel('help_documents');
