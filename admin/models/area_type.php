...
{    
	...
	public function getItem($pk = null)
	{
		if ($item = parent::getItem($pk))
		{
			...
			if (!empty($item->id))
			{
				...
				$item->tags->getTagIds($item->id, 'com_supportgroups.area_type');
			}
		}
	...
	{
		// Get the form.
		$form = $this->loadForm('com_supportgroups.area_type', 'area_type', array('control' => 'jform', 'load_data' => $loadData));
	...
	{
		return 'administrator/components/com_supportgroups/models/forms/area_type.js';
	}
