...
class SupportgroupsModelHelp_document extends JModelAdmin
{
	...
	public function getForm($data = array(), $loadData = true, $options = array('control' => 'jform'))
	{
		...
		// Get the form.
		$form = $this->loadForm('com_supportgroups.help_document', 'help_document', $options, $clear, $xpath);
	...
	{
		return 'media/com_supportgroups/js/help_document.js';
	}
	...
	protected function loadFormData() 
	{
		...
		if (empty($data))
		{
			...
			$this->preprocessData('com_supportgroups.help_document', $data);
		}
