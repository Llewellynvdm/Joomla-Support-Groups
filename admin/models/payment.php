...
class SupportgroupsModelPayment extends JModelAdmin
{
	...
	public function getForm($data = array(), $loadData = true, $options = array('control' => 'jform'))
	{
		...
		// Get the form.
		$form = $this->loadForm('com_supportgroups.payment', 'payment', $options, $clear, $xpath);
	...
	{
		return 'media/com_supportgroups/js/payment.js';
	}
	...
	protected function loadFormData() 
	{
		...
		if (empty($data))
		{
			...
			$this->preprocessData('com_supportgroups.payment', $data);
		}
	...
	protected function batchCopy($values, $pks, $contexts)
	{
		...
		while (!empty($pks))
		{
			...
			{
				$this->table->support_group = $this->generateUnique('support_group',$this->table->support_group);
			}
