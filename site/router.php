...
/**
 * Routing class from com_supportgroups
 *
 * @since  3.3
 */
class SupportgroupsRouter extends JComponentRouterBase
{	
	/**
	 * Build the route for the com_supportgroups component
	 *
...
function SupportgroupsBuildRoute(&$query)
{
