...
/**
 * Supportgroups Component Controller
 */
class SupportgroupsController extends JControllerLegacy
{
	...
	function display($cachable = false, $urlparams = false)
	{
		...
		if($isEdit)
		{
			if ($layout == 'edit' && !$this->checkEditId('com_supportgroups.edit.'.$view, $id))
			{
				...
				else
				{
					...
					$this->setRedirect(JRoute::_('index.php?option=com_supportgroups&view=supportgroups', false));
				}
				return false;
			}
		}
		...
		if (SupportgroupsHelper::checkArray($urlparams))
		{
			$safeurlparams = SupportgroupsHelper::mergeArrays(array($urlparams, $safeurlparams));
		}
